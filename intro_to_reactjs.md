      ...
      const header = (
        <header>
          <div className="header-wrapper">
            ...
            <h2>Getting Started React</h2>
            <h3>JavaScript Library</h3>
            <p>Instructor: Adebowale Julius</p>
...
const authorFirstName = "Adebowale";
const authorLastName = "Julius";
const date = "Oct 1, 2023";
...
🌕 You are awesome. You have just completed day 2 Classs and you are two steps ahead on your way to greatness. Now do some exercises for your brain and for your muscle.
