<div align="center">
  ...
  <a class="header-badge" target="_blank" href="https://twitter.com/Adebowale">
    <img alt="Twitter Follow" src="https://img.shields.io/twitter/follow/Juadeb1?style=social">
  </a>

<sub>Author:
<a href="https://www.juadebfm.com" target="_blank">Julius Adebowale</a><br>
...
If you do not feel comfortable with data types check the following [link](https://github.com/Juadebfm/JavaScript_For_Beginners/tree/datatypes)
...
let txt =
  "I love teaching and empowering people. I teach HTML, CSS, JS, React, NodeJS.";
...
const names = ["Adebowale", "Mathias", "Elias", "Brook"];
console.log(names.toString()); // Adebowale,Mathias,Elias,Brook
```
...
console.log(names.join()); // Adebowale,Mathias,Elias,Brook
console.log(names.join("")); //AdebowaleMathiasEliasBrook
console.log(names.join(" ")); //Adebowale Mathias Elias Brook
console.log(names.join(", ")); //Adebowale, Mathias, Elias, Brook
console.log(names.join(" # ")); //Adebowale # Mathias # Elias # Brook
...
sort: arrange array elements in ascending order. Sort takes a call back function, we will see how we use sort with a call back function in the coming classes.
...
1. The following is an array of 10 students ages:
   ...
   1.Slice the first ten countries from the [countries array](https://github.com/Juadebfm/JavaScript_For_Beginners/blob/arrays/countrydata.js)

1. Find the middle country(ies) in the [countries array](https://github.com/Juadebfm/JavaScript_For_Beginners/blob/arrays/countrydata.js)
...
const user = {
  ...
  age: 250,
  country: "Nigeria",
  skills: ["HTML", "CSS", "JS", "React", "Node", "NodeJS", "D3.js"],
};
...
function letsLearnScope() {
  ...
  if (true) {
    ...
    let b = 20;
    let d = 40;
    console.log(a, b, c); // NodeJS 20 30
  }
...
```sh
Adebowale Julius is a mentor.
He lives in Nigeria.
He teaches HTML, CSS, JavaScript, React, Node, MongoDB, NodeJS, D3.js, Meteor, and SasS.
```
...
console.log(printFullName("Adebowale", "Julius"));
```
...
console.log(greetings("Adebowale"));
```

```js
function generateFullName(firstName = "Adebowale", lastName = "Julius") {
  let space = " ";
  let fullName = firstName + space + lastName;
  return fullName;
}
...
```js
const generateFullName = (firstName = "Adebowale", lastName = "Julius") => {
  let space = " ";
  let fullName = firstName + space + lastName;
  return fullName;
};
...
let swe = countries[1];
let nor = countries[2];
console.log(fin, swe, nor); // Nigeria, Sweden, Norway
```
...
```js
const countries = ["Nigeria", "Sweden", undefined, "Norway"];
const [fin, swe, ice = "Iceland", nor, den = "Denmark"] = countries;
console.log(fin, swe, ice, nor, den); // Nigeria, Sweden, Iceland, Norway, Denmark
```
...
During destructuring if we are not interested in every item, we can omit a certain item by putting a comma at that index. Let's get only Nigeria, Iceland, and Denmark from the array. See the example below for more clarity:

```js
const countries = ["Nigeria", "Sweden", "Iceland", "Norway", "Denmark"];
const [fin, , ice, , den] = countries;
console.log(fin, ice, den); // Nigeria, Iceland, Denmark
```
...
// Germany, France,  ["Nigeria", "Sweden", "Norway", "Denmark", "Iceland"]
```
...
skills:['JS', 'React', 'Redux', 'Node', 'NodeJS']
...
/*
Adebowale Julius lives in Nigeria. He is  250 years old. He is an Instructor and Developer. He teaches HTML, CSS, JavaScript, React, Redux, Node, MongoDB, NodeJS and D3.js. He speaks Yoruba, English and a little bit of Pidgin
*/
```
...
```sh
{name: "Adebowale", title: "Programmer", country: "Nigeria", city: "Lagos"}
```
...
```sh
{name: "Adebowale", title: "instructor", country: "Nigeria", city: "Lagos"}
```
...
```js
const countries = ["Nigeria", "Estonia", "Sweden", "Norway"];
...
console.log(newCountries); // ["Nigeria", "Estonia", "Sweden", "Norway"]
```
...
```js
const countries = ["Nigeria", "Estonia", "Sweden", "Norway", "Iceland"];
const countriesWithLand = countries.filter((country) =>
  country.includes("land")
);
console.log(countriesWithLand); // ["Nigeria", "Iceland"]
```
...
const person1 = new Person("Adebowale", "Julius");

console.log(person1);
```

```sh
Person {firstName: "Adebowale", lastName: "Julius"}
```
...
const person3 = new Person("Abraham", "Julius");
...
Person {firstName: "Abraham", lastName: "Julius"}
```
...
const person1 = new Person("Adebowale", "Julius", 250, "Nigeria", "Lagos");

console.log(person1);
```

```sh
Person {firstName: "Adebowale", lastName: "Julius", age: 250, country: "Nigeria", city: "Lagos"}
```
...
["Planning", "Managing", "Organizing"]
[]
Adebowale Julius is 250. He lives Lagos, Nigeria. He knows HTML, CSS and JavaScript
...
class Person {
  ...
  static favoriteSkill() {
    const skills = ["HTML", "CSS", "JS", "React", "NodeJS", "Node"];
...
const s1 = new Student("Adebowale", "Julius", "Nigeria", 250, "Lagos");
console.log(s1);
...
```sh
Student {firstName: "Adebowale", lastName: "Julius", age: "Nigeria", country: 250, city: "Lagos", …}
I am a child of the person class
Adebowale Julius
Student {firstName: "Adebowale", lastName: "Julius", age: "Nigeria", country: 250, city: "Lagos", …}
Adebowale Julius is Nigeria. He lives Lagos, 250.
```
...
```sh
Student {firstName: "Adebowale", lastName: "Julius", age: 250, country: "Nigeria", city: "Lagos", …}
Student {firstName: "Lidiya", lastName: "Tekle", age: 28, country: "Nigeria", city: "Lagos", …}
I am a child of the person class
Adebowale Julius
Student {firstName: "Adebowale", lastName: "Julius", age: 250, country: "Nigeria", city: "Lagos", …}
Adebowale Julius is 250. He lives in Lagos, Nigeria. He knows HTML, CSS and JavaScript
I am a child of the person class
Lidiya Tekle
Student {firstName: "Lidiya", lastName: "Tekle", age: 28, country: "Nigeria", city: "Lagos", …}
...
This is a refresher course for JavaScript. Knowing this topics enables you to be more efficient and in knowledge and use of ReactJS.